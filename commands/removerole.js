...
module.exports.run = async (bot, message, args) => {
    ...
    try{
        await rMember.send(`I'm sorry, you have lost the "${gRole.name}" role on ${message.guild.name}!`)
        }catch(e){
    message.channel.send(`I'm sorry, <@${rMember.id}>, you have lost the ${gRole.name} role. Please unlock your DM's to server members to recieve further role updates!`);
    }
}
